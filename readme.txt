=== Lightweight FAQs ===
Contributors: orixlab, shameemreza
...
**Extremely Lightweight (<50kb):** Lightweight FAQs plugin is very simple and its size is within 50kb. Its dont have any useless code or files. Lightweight FAQs also dont load any extra code on front end.
...
**[Live Demo](https://demo.orixlab.net/wporg/lightweight-faqs/)**
 ...
 * Initial Release.
 ...
 = 0.0.2 =
 * Tested with WordPress and Elementor Latest Version.
